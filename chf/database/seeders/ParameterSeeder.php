...
class ParameterSeeder extends Seeder
{
    ...
    public function run()
    {
        ...
        DB::table('parameters')->insert([
            ...
            'threshold_min' => 60,
            'threshold_max' => 100,
            'instructions' => '<p>Do not measure your heart rate within one to two hours after exercise or a stressful event. Your heart rate can stay elevated after strenuous activities.</p><p>Wait an hour after consuming caffeine, which can cause heart palpitations and make your heart rate rise.</p><p>Do not take the reading after you have been sitting or standing for a long period, which can affect your heart rate.</p>',
        ]);
        ...
        DB::table('parameters')->insert([
            ...
            'measurement_span' => 'week',
            'threshold_min' => 95,
            'instructions' => '<p>Remove any nail polish from the finger you will use to take the measurement - always use the same finger.</p><p>Place the place oximeter on the finger and start the measurement. You may feel a small amount of pressure, but no pain or pinching.</p>',
        ]);
