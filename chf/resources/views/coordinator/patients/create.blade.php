        ...
        <div class="row">
                ...
                <div class="row">
                    ...
                    <div class="col-6">
                        <div class="form-group">
                            ...
                            <input type="number" class="form-control" id="age" name="age" placeholder="65" required>
                        </div>
                    </div>
            ...
            <div class="col-6">
                ...
                <div class="parameters">
                    ...
                    <button class="btn btn-outline-primary m-1" type="button" data-toggle="collapse" data-target="#{{ 'collapse'.$parameter->id.'param' }}" aria-expanded="false" aria-controls="{{ 'collapse'.$parameter->id.'param' }}">
