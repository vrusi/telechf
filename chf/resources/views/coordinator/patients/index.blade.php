        ...
        <ul class="nav nav-tabs">
            <li class="nav-item">
                <a class="{{ $active ? 'nav-link active' : 'nav-link' }}"
                    href="{{ route('patients.index', ['inactive' => false]) }}">{{ __('Active patients') }}</a>
            </li>

            <li class="nav-item">
                <a class="{{ !$active ? 'nav-link active' : 'nav-link' }}"
                    href="{{ route('patients.index', ['inactive' => true]) }}">{{ __('Inactive patients') }}</a>
            </li>
        </ul>
                        ...
                        <td>
                            @if ($active)
                                <a class="btn btn-outline-danger btn-sm"
                                    href="{{ url('/coordinator/patients/' . $patient['id'] . '/deactivate') }}">
                                    <i class="fas fa-user-minus"></i>
                                </a>
                            @else
                                <a class="btn btn-outline-success btn-sm"
                                    href="{{ url('/coordinator/patients/' . $patient['id'] . '/restore') }}">
                                    <i class="fas fa-user-plus"></i>
                                </a>
                            @endif
                        </td>
