...
Route::get('/profile/create', 'App\Http\Controllers\Patient\ProfileController@create')->middleware(['auth']);
Route::post('/profile', 'App\Http\Controllers\Patient\ProfileController@store')->middleware(['auth']);
